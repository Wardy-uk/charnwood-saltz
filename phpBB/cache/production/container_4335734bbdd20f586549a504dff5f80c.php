...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'j5bq_oauth_tokens', 'j5bq_oauth_states', 'j5bq_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'j5bq_users', $this, $this->get('dispatcher'), './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'j5bq_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'j5bq_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'j5bq_forums', 'j5bq_posts', 'j5bq_topics', 'j5bq_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('j5bq_captcha_questions', 'j5bq_captcha_answers', 'j5bq_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'j5bq_ext', './', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'j5bq_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'j5bq_migrations', './', 'php', 'j5bq_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './', 'php', 'j5bq_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'j5bq_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'j5bq_notification_types', 'j5bq_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'j5bq_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'j5bq_notification_types', 'j5bq_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'j5bq_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'j5bq_profile_fields', 'j5bq_profile_lang', 'j5bq_profile_fields_data');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000555aadeb000000003eddedde(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'j5bq_bbcodes', 'j5bq_smilies', 'j5bq_styles', 'j5bq_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'j5bq_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'j5bq_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'j5bq_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'j5bq_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'j5bq_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'j5bq_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'j5bq_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'j5bq_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'j5bq_acl_groups',
            'tables.acl_options' => 'j5bq_acl_options',
            'tables.acl_roles' => 'j5bq_acl_roles',
            'tables.acl_roles_data' => 'j5bq_acl_roles_data',
            'tables.acl_users' => 'j5bq_acl_users',
            'tables.attachments' => 'j5bq_attachments',
            'tables.auth_provider_oauth_token_storage' => 'j5bq_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'j5bq_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'j5bq_oauth_accounts',
            'tables.banlist' => 'j5bq_banlist',
            'tables.bbcodes' => 'j5bq_bbcodes',
            'tables.bookmarks' => 'j5bq_bookmarks',
            'tables.bots' => 'j5bq_bots',
            'tables.captcha_qa_questions' => 'j5bq_captcha_questions',
            'tables.captcha_qa_answers' => 'j5bq_captcha_answers',
            'tables.captcha_qa_confirm' => 'j5bq_qa_confirm',
            'tables.config' => 'j5bq_config',
            'tables.config_text' => 'j5bq_config_text',
            'tables.confirm' => 'j5bq_confirm',
            'tables.disallow' => 'j5bq_disallow',
            'tables.drafts' => 'j5bq_drafts',
            'tables.ext' => 'j5bq_ext',
            'tables.extensions' => 'j5bq_extensions',
            'tables.extension_groups' => 'j5bq_extension_groups',
            'tables.forums' => 'j5bq_forums',
            'tables.forums_access' => 'j5bq_forums_access',
            'tables.forums_track' => 'j5bq_forums_track',
            'tables.forums_watch' => 'j5bq_forums_watch',
            'tables.groups' => 'j5bq_groups',
            'tables.icons' => 'j5bq_icons',
            'tables.lang' => 'j5bq_lang',
            'tables.log' => 'j5bq_log',
            'tables.login_attempts' => 'j5bq_login_attempts',
            'tables.migrations' => 'j5bq_migrations',
            'tables.moderator_cache' => 'j5bq_moderator_cache',
            'tables.modules' => 'j5bq_modules',
            'tables.notification_types' => 'j5bq_notification_types',
            'tables.notifications' => 'j5bq_notifications',
            'tables.poll_options' => 'j5bq_poll_options',
            'tables.poll_votes' => 'j5bq_poll_votes',
            'tables.posts' => 'j5bq_posts',
            'tables.privmsgs' => 'j5bq_privmsgs',
            'tables.privmsgs_folder' => 'j5bq_privmsgs_folder',
            'tables.privmsgs_rules' => 'j5bq_privmsgs_rules',
            'tables.privmsgs_to' => 'j5bq_privmsgs_to',
            'tables.profile_fields' => 'j5bq_profile_fields',
            'tables.profile_fields_data' => 'j5bq_profile_fields_data',
            'tables.profile_fields_options_language' => 'j5bq_profile_fields_lang',
            'tables.profile_fields_language' => 'j5bq_profile_lang',
            'tables.ranks' => 'j5bq_ranks',
            'tables.reports' => 'j5bq_reports',
            'tables.reports_reasons' => 'j5bq_reports_reasons',
            'tables.search_results' => 'j5bq_search_results',
            'tables.search_wordlist' => 'j5bq_search_wordlist',
            'tables.search_wordmatch' => 'j5bq_search_wordmatch',
            'tables.sessions' => 'j5bq_sessions',
            'tables.sessions_keys' => 'j5bq_sessions_keys',
            'tables.sitelist' => 'j5bq_sitelist',
            'tables.smilies' => 'j5bq_smilies',
            'tables.sphinx' => 'j5bq_sphinx',
            'tables.styles' => 'j5bq_styles',
            'tables.styles_template' => 'j5bq_styles_template',
            'tables.styles_template_data' => 'j5bq_styles_template_data',
            'tables.styles_theme' => 'j5bq_styles_theme',
            'tables.styles_imageset' => 'j5bq_styles_imageset',
            'tables.styles_imageset_data' => 'j5bq_styles_imageset_data',
            'tables.teampage' => 'j5bq_teampage',
            'tables.topics' => 'j5bq_topics',
            'tables.topics_posted' => 'j5bq_topics_posted',
            'tables.topics_track' => 'j5bq_topics_track',
            'tables.topics_watch' => 'j5bq_topics_watch',
            'tables.user_group' => 'j5bq_user_group',
            'tables.user_notifications' => 'j5bq_user_notifications',
            'tables.users' => 'j5bq_users',
            'tables.warnings' => 'j5bq_warnings',
            'tables.words' => 'j5bq_words',
            'tables.zebra' => 'j5bq_zebra',
...
class phpbbtemplatetwiglexer_00000000555aadeb000000003eddedde extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d110c1c9930c005927689 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d110c1c9931c179438708 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d110c1c992e8639825497 = array(
    ...
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, 'set_environment', array('env' => $env), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;

        return $this->valueHolder5d110c1c9930c005927689->set_environment($env);
    }
    ...
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;

        return $this->valueHolder5d110c1c9930c005927689->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;

        return $this->valueHolder5d110c1c9930c005927689->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d110c1c9931c179438708 = $initializer;
    }
    ...
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, '__get', array('name' => $name), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;

        if (isset(self::$publicProperties5d110c1c992e8639825497[$name])) {
            return $this->valueHolder5d110c1c9930c005927689->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d110c1c9930c005927689;
    ...
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;
    ...
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, '__isset', array('name' => $name), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;
    ...
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, '__unset', array('name' => $name), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;
    ...
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, '__clone', array(), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;

        $this->valueHolder5d110c1c9930c005927689 = clone $this->valueHolder5d110c1c9930c005927689;
    }

    public function __sleep()
    {
        $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, '__sleep', array(), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;

        return array('valueHolder5d110c1c9930c005927689');
    }
    ...
    {
        return $this->initializer5d110c1c9931c179438708;
    }
    ...
    {
        return $this->initializer5d110c1c9931c179438708 && ($this->initializer5d110c1c9931c179438708->__invoke($valueHolder5d110c1c9930c005927689, $this, 'initializeProxy', array(), $this->initializer5d110c1c9931c179438708) || 1) && $this->valueHolder5d110c1c9930c005927689 = $valueHolder5d110c1c9930c005927689;
    }
    ...
    {
        return null !== $this->valueHolder5d110c1c9930c005927689;
    }
    ...
    {
        return $this->valueHolder5d110c1c9930c005927689;
    }
